...
def logic_calculation(height_of_AB : int, height_of_AD : int, length_of_AB : int, length_of_AD : int, width_of_AB : int, width_of_AD : int):
...
# Program Output
def display_output(total_blocks : int, total_blocks_for_length : int, total_blocks_for_breadth : int, intersecting_blocks : int, stacks : int, remainder : int):
